        ...
        <div class="add-info-detail">
          ...
          <div class="add-info-box-row">
            <div class="add-info-img">
              <img :src="'http://127.0.0.1:9001/product/img/'+newShoppingCart.product.img" alt="">
            </div>
            <div class="add-info-intro">
              <p>{{newShoppingCart.product.name}}</p>
...
<!--            <router-link to="/goodsDetail">-->
            <button class="btn-car btn-car-to-detail" @click="goDetail()">查看商品详情</button>
<!--            </router-link>-->
...
export default {
  ...
  methods: {
    ...
    goDetail(){
      this.$router.push({name: 'GoodsDetail',query:{productid: this.newShoppingCart.product.id}})
    }
  },
  components: {
    Sreach,
