  ...
  <div class="box">
    <div class="nav">
      ...
      <ul class="detail">
              ...
              <div class="shopping-cart-list" v-show="shoppingCart.length > 0">
                <div class="shopping-cart-box" v-for="(item,index) in shoppingCart" :key="index">
                  <div class="shopping-cart-img">
                    <img :src="'http://127.0.0.1:9001/product/img/'+item.product.img">
                  </div>
                  <div class="shopping-cart-info">
                    <div class="shopping-cart-title">
                      <p>{{item.product.name.substring(0, 22)}}...</p>
                    </div>
        ...
        <li><a href="http://127.0.0.1:8002">进入后台</a></li>
...
export default {
  ...
  mounted () {
    let father = this;
    this.isLogin();
    let userInfo0=JSON.parse(localStorage.getItem("userInfo"));
    ...
    // if(userInfo0!=null) this.userInfo = userInfo0;
  },
  data () {
    return {
      // userInfo: {},
